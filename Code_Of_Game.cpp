...
void begin()               
{
 ...
 cleardevice();
 setcolor(GREEN);
 outtextxy(20,-50+i,"   SNAKE  &  LADDER  GAME   ");
 delay(30);
 }
 for(i=0;i<600;i+=5)
 {
 ...
 settextstyle(2,0,5);
  ...
  for(i=0;i<150;i++)
  {
  rectangle(100+i,270,500,290);
  delay(30);
  }
  delay(4000);
   setcolor(MAGENTA);
  for(i=0;i<250;i++)
  {  rectangle(100,270,250+i,290);
      delay(40);
  }
  delay(600);
  settextstyle(4,0,3);
  textcolor(CYAN);
  outtextxy(190,300,"Press any key to continue...");
  getch();
  setcolor(BLUE);
  for(i=0;i<250;i++)
  {
...
/* ----------------------MAKE SOUND ON OPENING THE GAME----------------------*/
...
void getdice()   //GIVE OUT PUT OF DICE
...
void end()
{
 ...
 clearviewport();
 setcolor(GREEN);
 outtextxy(200,500-i,"1:- RAHUL SINGH");
 delay(40);
 }
